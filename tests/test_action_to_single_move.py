...
class DummyDoublesPlayer(RandomDoublesPlayer):
    ...
    # Basically, on the first move, take the existing battle state and go through all possible inputs for
    # _action_to_move and print out the mapping between the action (int) and the output (DoubleBattleOrder) to verify
